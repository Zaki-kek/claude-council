...
```bash
# 1. Install (clone locally, then load as a plugin dir - see Installation below)
git clone https://github.com/Zaki-kek/claude-council.git
...
> Replace `Zaki-kek` below with your own GitHub namespace once you publish the repo.
...
If you publish this plugin through your own Claude Code marketplace, install it with:

```bash
/plugin marketplace add Zaki-kek/claude-marketplace
...
4. Commit and push
5. Users reinstall / update from your published source
